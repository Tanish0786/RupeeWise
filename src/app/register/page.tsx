    ...
    <div className="min-h-screen bg-[#050816] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="glass-panel p-8 rounded-2xl shadow-2xl relative overflow-hidden">
          ...
          <p className="text-xs text-[#94A3B8] mb-6">Start your journey with autonomous wealth engines.</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2.5 mt-1">
              <input
                ...
                className="w-4 h-4 rounded border-white/[0.08] bg-[#050816] text-[#3D4FE0] focus:ring-[#3D4FE0] focus:ring-offset-0 cursor-pointer"
              />
          ...
          <div className="mt-6 text-center">
            <span className="text-xs text-[#94A3B8]">
              ...
              <Link href="/login" className="text-[#3D4FE0] font-semibold hover:text-[#3D4FE0]/80 transition-colors">
                Sign In
              </Link>
            </span>
          </div>
